...
import { paymentsService } from '@/src/modules/dashboard/pages/payments/services'
import { TableHistory } from '@/src/modules/dashboard/pages/payments/tableHistory'
import { TableSchedule } from '@/src/modules/dashboard/pages/payments/tableSchedule'
