...
export const Schedule = () => {
	...
	useEffect(() => {
		...
		const close = (e: MouseEvent) => {
			const el = calendarAnchorRef.current
	...
	return (
		<div className='flex h-full w-full flex-col'>
			<div className='relative z-10 shrink-0 border-b border-gray-200 bg-white p-4'>
				<div className='flex flex-col gap-3'>
					...
					<div ref={calendarAnchorRef} className='relative'>
						...
						{calendarOpen && (
							<div
								className='absolute top-full right-0 z-100 mt-1 w-[min(280px,calc(100vw-2rem))] rounded-lg border border-gray-200 bg-white p-2 shadow-lg'
								role='dialog'
								aria-label={intl.formatMessage({ id: 'schedule_open_calendar' })}
							>
