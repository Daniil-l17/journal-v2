...
export const Login = () => {
  ...
  return (
    <div className='flex min-h-svh items-center justify-center bg-color-background px-4 sm:px-8'>
      <div className='w-full max-w-5xl text-center p-4 flex flex-col gap-4 sm:gap-6'>
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center'>
          <Button color='#d91842' size='lg' radius='md' className='px-8' onClick={handleOpenModal}>
            Войти в аккаунт
          </Button>
        </div>
      </div>
